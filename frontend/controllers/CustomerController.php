    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $checkUserAlreadyRegisterAsCustomer = Customer::find()->where([
                    'user_id' => Yii::$app->user->id
                ])->one();

                if ($checkUserAlreadyRegisterAsCustomer != null) {
                    Yii::$app->session->setFlash("error", "User sudah pernah mendaftar");
